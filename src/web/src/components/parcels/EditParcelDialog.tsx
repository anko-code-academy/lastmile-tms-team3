...
export function EditParcelDialog({ parcel, onClose, onSaved }: Props) {
  const [form, setForm] = useState<EditParcelInput>({
    ...
    recipientAddress: {
      ...
      latitude: parcel.recipientAddress.latitude,
      longitude: parcel.recipientAddress.longitude,
    },
    shipperAddress: {
      ...
      countryCode: parcel.shipperAddress.countryCode,
      ...
      latitude: parcel.shipperAddress.latitude,
      longitude: parcel.shipperAddress.longitude,
    },
